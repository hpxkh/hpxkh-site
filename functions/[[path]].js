 ...
 *   4. 掛上 assets/copy.js、calendar.js、fixes.js、fixes2.js、fixes3.js、fixes4.js、fixes5.js
 ...
 * fixes4.js：第三批小調整（里程碑與它的時間範圍按鈕、常見問題題號…）。
 * fixes5.js 最後：第四批，它要複製 fixes2.js 處理過的版規十條。
 *
 * ── 關於 VER ──
 * 本網域的 Cloudflare「Browser Cache TTL」設為 4 小時，會把靜態檔的
 * max-age 一律拉到 14400，_headers 只能拉長不能縮短。因此改用版本化網址：
 * 每次改動 copy.js / calendar.js / fixes.js / fixes2.js / fixes3.js / fixes4.js / fixes5.js / favicon.svg 後把 VER 改掉。
 */
const VER = '20260920a';
...
const SCRIPTS =
  ...
  '<script src="/assets/fixes5.js?v=' + VER + '"></script>';
